...
Raman spectroscopy provides unique "fingerprints" for chemical compounds, but observed spectra are often combinations of constituent spectra. This project uses Bayesian methods to unmix these signals, allowing for:
- Incorporation of prior knowledge about chemical components
- Quantification of uncertainty in source separation
- Probabilistic inference using JAGS for Gibbs sampling
